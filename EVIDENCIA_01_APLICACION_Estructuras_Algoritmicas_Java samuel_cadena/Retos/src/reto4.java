...
public class reto4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(opcionAleatoria==1 && opcion==1){
            ...
            System.out.println("respuesta piedra");
            System.out.println( nombre+" has perdido la respuesta de la maquina es: "+ opcionAleatoria + " tu respuesta es: " + opcion +" y tu valor final es de:"+ (tope-apuesta));
        }
        else if(opcionAleatoria==3 && opcion==1){
            System.out.println("respuesta es piedra");
            System.out.println( nombre+" has ganado la respuesta de la maquina es: "+ opcionAleatoria +" tu respuesta es: " + opcion +" y tu valor final es de:"+ (tope+apuesta));
        }
        ...
        System.out.println("!Gracias por jugar este juegaso¡"); 
